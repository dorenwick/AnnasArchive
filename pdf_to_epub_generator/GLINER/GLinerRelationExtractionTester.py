...
def setup_pipeline():
    # r"C:\Users\doren\PycharmProjects\CiteGrabberFinal\CreateRelationDataset\gliner_dataset\checkpoint-400"
    ...
    predictor = GLiNERPredictor(
        GLiNERPredictorConfig(
            model_name=r"knowledgator/gliner-multitask-large-v0.5",
...
def analyze_text(pipe, text: str) -> dict:
        ...
        "relations": [
            {
                "relation": "authored",
                "pairs_filter": [
                    ("author", "scholarly work"),
                    ("author", "book"),
                    ("author", "written article")
                ],
            ...
            {
                "relation": "published in year",
                "pairs_filter": [
                    ("scholarly work", "publication venue"),
                    ("book", "publication venue"),
                    ("written article", "publication venue")
                ],
                "distance_threshold": 250,
            },
            {
            ...
            },
            {
                ...
                "pairs_filter": [
                    ("scholarly work", "research institute"),
                    ("book", "research institute"),
                    ("written article", "research institute")
                ],
                "distance_threshold": 250,
            },
            {
                "relation": "published in",
                "pairs_filter": [("author", "publication year")],
                "distance_threshold": 175,
            },
            {
                "relation": "published in year",
                "pairs_filter": [
                    ("scholarly work", "publication year"),
                    ("book", "publication year"),
                    ("written article", "publication year")
                ],
                "distance_threshold": 200,
            }
        ]
    ...
    for auth_rel in authored_relations:
        ...
        work_metadata = {
            ...
            'year': next((r['target'] for r in relations if
                          r['relation'] == 'published in year' and r['source']['span'] == work['span']), None),
        ...
        for coauthor_span in coauthors:
            ...
            if coauthor:
                ...
                if work_metadata['year']:
                    enhanced_relations.append({
                        "relation": "published in year",
                        "source": coauthor,
                        "target": work_metadata['year'],
                        "score": auth_rel['score'] * 0.95
                    })
