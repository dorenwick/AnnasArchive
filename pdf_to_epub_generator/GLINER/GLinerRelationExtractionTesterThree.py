...
def analyze_text(pipe, text: str) -> dict:
    ...
    # Process co-authorship information for all work types
...
def main():
    ...
    for idx, text in enumerate(paragraphs, 1):
        ...
        try:
            ...
            # Print detailed relations
            print("\nDetailed relations:")
            for relation in results["relations"]:
                print(
                    f"- {relation['source']['span']} {relation['relation']} {relation['target']['span']} (score: {relation['score']:.3f})")
